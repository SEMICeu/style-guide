...
Note that **not** all artefacts are treated in the current style-guide, but only the ones that are in scope of the Semantic interoperability layer of the EIF framework.
