...
See [xref:references.adoc#ref:oslo-rules[oslo-rules, sec 3.2.6]], [xref:references.adoc#ref:epo-cmc[epo-cmc, sec 4.4]]
...
* minimise the number of crossing connectors [xref:references.adoc#ref:oslo-rules[oslo-rules, sec 3.3.4]]
* prefer orthogonal to straight connectors [xref:references.adoc#ref:oslo-rules[oslo-rules, sec 3.3.1]]
* align elements horizontally & vertically [xref:references.adoc#ref:oslo-rules[oslo-rules, sec 3.3.4]]
...
* place subclasses under or to the right of their parent [xref:references.adoc#ref:oslo-rules[oslo-rules, sec 3.3.5]] 
* place the part under or to the right of the whole at aggregates or composites [xref:references.adoc#ref:oslo-rules[oslo-rules, sec 3.3.1]].
...
** simplify complex diagrams [xref:references.adoc#ref:oslo-rules[oslo-rules, sec 3.3.3]]:
...
** elements of equal importance  should be equally large [xref:references.adoc#ref:oslo-rules[oslo-rules, sec 3.3.2]].
* inherited attributes of a superclass shall be visible if the superclass is not in the diagram [xref:references.adoc#ref:oslo-rules[oslo-rules, sec 3.2.5]].

See also [xref:references.adoc#ref:oslo-rules[oslo-rules, sec 3.1.11]], [xref:references.adoc#ref:semic-sgdraft[semic-sgdraft, sec on UML, Rules 13-23]]
****
*Examples:*
