...
subsequent character positions. [xref:references.adoc#ref:22[22, sec 4.2]] _resolve references from the original doc_ - [???]
...
\ [xref:references.adoc#ref:22[22, sec 3.2]], [xref:references.adoc#ref:19[19, sec 3.2.20]]
